...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-16 items-center justify-center rounded-full border-2 border-slate-300 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
...
export function AnimatedBeamDemo() {
    ...
    return (
      <div
        className="relative flex h-[280px] w-full items-center justify-center overflow-visible p-6"
        ref={containerRef}
      >
        <div className="flex size-full flex-col items-stretch justify-center gap-4">
        ...
        <AnimatedBeam containerRef={containerRef} fromRef={div1Ref} toRef={div4Ref} curvature={-75} pathWidth={8} />
        <AnimatedBeam containerRef={containerRef} fromRef={div2Ref} toRef={div4Ref} pathWidth={8} />
        <AnimatedBeam containerRef={containerRef} fromRef={div3Ref} toRef={div4Ref} curvature={75} pathWidth={8} />
        <AnimatedBeam containerRef={containerRef} fromRef={div5Ref} toRef={div4Ref} curvature={-75} pathWidth={8} reverse />
        <AnimatedBeam containerRef={containerRef} fromRef={div6Ref} toRef={div4Ref} pathWidth={8} reverse />
        <AnimatedBeam containerRef={containerRef} fromRef={div7Ref} toRef={div4Ref} curvature={75} pathWidth={8} reverse />
      </div>
